# @discere-os/flac.wasm

WebAssembly port of FLAC - Free Lossless Audio Codec with SIMD optimization and comprehensive TypeScript interface for professional audio processing.

[![CI/CD](https://github.com/discere-os/discere-nucleus/actions/workflows/flac-wasm-ci.yml/badge.svg)](https://github.com/discere-os/discere-nucleus/actions)
[![JSR](https://jsr.io/badges/@discere-os/flac.wasm)](https://jsr.io/@discere-os/flac.wasm)
[![npm version](https://badge.fury.io/js/@discere-os%2Fflac.wasm.svg)](https://badge.fury.io/js/@discere-os%2Fflac.wasm)
[![License](https://img.shields.io/badge/License-Xiph-blue.svg)](LICENSE)
